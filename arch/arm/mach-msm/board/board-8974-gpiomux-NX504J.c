...
#if 0//def CONFIG_ZTE_CAMERA_Z7
	{
		.func = GPIOMUX_FUNC_2, /*active 0*/ /* 5 */
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
	},

	{
		.func = GPIOMUX_FUNC_2, /*suspend 0*/ /* 6 */
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_DOWN,
	},
#endif
...
static struct gpiomux_setting sd_card_det_active_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP, /* Z7 mini: pull up SD_CARD_DET */
	.dir = GPIOMUX_IN,
};
...
#if defined(CONFIG_ZTE_CAMERA_Z7) || defined(CONFIG_ZTE_CAMERA_Z7MINI)|| defined(CONFIG_ZTE_CAMERA_NX504J)
...
#if defined(CONFIG_ZTE_CAMERA_Z7) || defined(CONFIG_ZTE_CAMERA_Z7MINI)
