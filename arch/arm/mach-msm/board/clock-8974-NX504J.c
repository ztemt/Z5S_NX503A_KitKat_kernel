...
#endif
#ifdef CONFIG_T4K35
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "35.qcom,camera"),
#endif
...
#endif
#ifdef CONFIG_T4K35
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "35.qcom,camera"),
#endif
...
static struct clk_lookup msm_clocks_8974_common[] __initdata = {
	...
	//add by chengdongsheng for NFC-qca1990 CLK 19.2M
